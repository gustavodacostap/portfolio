        ...
        <main className="pt-12 px-5 sm:px-6 md:px-12 lg:px-[10%] xl:px-[13%] 2xl:px-[15%]">
            ...
            <div className="flex flex-col md:flex-row md:gap-10">
                <div className="flex flex-col gap-5 mt-5 md:w-2/3">
                    <p>{t("description")}</p>
                    <Link href="https://password-generator-react-ts.vercel.app/" target="_blank" className="text-right text-lg md:text-xl">
            ...
            <footer className="my-5">
                <nav className="flex items-center justify-between">
                    <Link href="/projects/TaskManagerWeb" className="font-medium text-lg md:text-xl">
                        {p("nextProject")}
                    </Link>
                    <Link href="/projects/TaskManagerWeb" className="text-right font-medium text-lg md:text-xl">
                        {t("titleNextProject")}
                    </Link>
                </nav>
            </footer>
